            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.CardBody(
                            [
                                html.H5("1v1 comparison", className="card-title"),
                                html.P("Choose two athletes and compare theirs performances"),
                                dbc.Button("Open", href="./ARD_DH.py", color="primary"),
                            ]
                        )
                    ),
                    width=3,
                    ...
                    dbc.Card(
                        dbc.CardBody(
                            [
                                ...
                                html.P("Scopri di più su di noi."),
                                dbc.Button("Vai", href="/about", color="primary"),
                            ]
                        )
                    ),
                    width=3,
                    ...
                    dbc.Card(
                        dbc.CardBody(
                            [
                                ...
                                html.P("Contattaci."),
                                dbc.Button("Vai", href="/contact", color="primary"),
                            ]
                        )
                    ),
                    width=3,
...
def display_page(pathname):
    if pathname == './ARD_DH.py':
        return ARD_DH.layout
